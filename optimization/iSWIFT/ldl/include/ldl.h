...
#define LDL_cache_numeric ldl_l_cache_numeric
...
#define LDL_cache_numeric ldl_cache_numeric
...
int ldl_cache_numeric(int n, int Ap[], int Ai[], double Ax[],
	int Ltp[], int Lti[], int Li[], int Lp[], double Lx[],
	double D[], double Y[], int P[], int Pinv[], int UPattern[]);
...
SuiteSparse_long ldl_l_cache_numeric(SuiteSparse_long n, SuiteSparse_long Ap[],
	SuiteSparse_long Ai[], double Ax[], SuiteSparse_long Ltp[], SuiteSparse_long Lti[],
	SuiteSparse_long Li[], SuiteSparse_long Lp[], double Lx[], double D[], double Y[],
	SuiteSparse_long P[], SuiteSparse_long Pinv[], SuiteSparse_long UPattern[]);


SuiteSparse_long ldl_l_row_cache_numeric(SuiteSparse_long n, SuiteSparse_long Ap[],
	SuiteSparse_long Ai[], double Ax[], SuiteSparse_long Ltp[], SuiteSparse_long Lti[],
	SuiteSparse_long Li[], SuiteSparse_long Lp[], double Lx[], double D[], double Y[],
	SuiteSparse_long P[], SuiteSparse_long Pinv[], SuiteSparse_long UPattern[]);
